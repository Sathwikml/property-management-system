          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            {payment.lateFee && parseFloat(payment.lateFee) > 0 && (
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-semibold text-red-600">
                  +${parseFloat(payment.lateFee).toFixed(2)}
                </span>
              </div>
            )}
            <div className="border-t border-blue-200 mt-2 pt-2 flex justify-between items-center">
              ...
              <span className="text-xl font-bold text-gray-900">
                ${(parseFloat(payment.amount || 0) + parseFloat(payment.lateFee || 0)).toFixed(2)}
              </span>
            </div>
          </div>
...
// Main Component
const PaymentHistoryWithPayments = () => {
...
export default PaymentHistoryWithPayments;
